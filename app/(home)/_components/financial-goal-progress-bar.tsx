...
const FinancialGoalProgressBar = ({ title, progress }: FinancialGoalProgressBarProps) => {
    return (
        <div className="grid grid-cols-[1fr_2fr_1fr] lg:grid-cols-[1fr_4fr_1fr] gap-4 items-center">
            <p className="text-font w-20 lg:w-40 text-ellipsis overflow-hidden font-[family-name:var(--font-poppins)] text-left">{title}</p>
