                ...
                <ScrollArea className="w-full">
                    ...
                    <div className="border-b-2 border-border/20 bg-card-foreground">
                        <div className="h-12 px-4 flex items-center gap-4">
                            ...
                            <Skeleton className="h-5 w-[80px]" /> {/* Recorrência */}
                            <Skeleton className="h-5 w-[80px]" /> {/* Pago */}
                            <Skeleton className="h-5 w-[80px]" /> {/* Vencimento */}
                        </div>
                    </div>
                    {/* Table rows */}
                    {[...Array(5)].map((_, index) => (
                        ...
                        >
                            <div className="w-full justify-between p-4 flex items-center">
                                ...
                                <Skeleton className="h-4 w-[80px]" /> {/* Recorrência */}
                                <Skeleton className="h-4 w-[80px]" /> {/* Pago */}
                                <Skeleton className="h-4 w-[80px]" /> {/* Vencimento */}
                            </div>
                        </div>
                    ))}
